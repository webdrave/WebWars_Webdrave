  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (visibleSection) {
          const newActive = sections.find((sec) => sec.id === visibleSection.target.id);
  ...
  <div className="w-full h-full flex flex-col justify-center items-center bg-[#A0C9E8]">
    <AnimatePresence mode="wait">
      ...
      <div className="mt-32 flex flex-col">
        <h1 className="text-4xl md:text-5xl font-bold text-center">Conference Committee</h1>
      </div>
      ...
      <Section id="Patron">
        <div className="flex flex-col gap-10">
          <PersonCard name="Prof.(Dr.) S.N. Singh" role="Director IIITM" location="Gwalior, India" image="/assets/persons/snsingh.jpeg" />
          <PersonCard name="Prof.(Dr.) M.K. Babu Kayala" role="VC" location="Galgotias University, India" image="/assets/persons/vcsir.jpg" />
        </div>
        <div className="flex flex-col gap-10">
          <PersonCard name="Dr. Dhruv Galgotia" role="CEO" location="Galgotias University, India" image="/assets/persons/dhruvSir.jpeg" />
          <PersonCard name="Ms. Aradhana Galgotia" role="Director Operations" location="Galgotias University, India" image="/assets/persons/aradhanaMaam.jpg" />
        </div>
      </Section>

      <Section id="Conference-General-Chair">
        <div className="flex flex-col gap-10">
          <PersonCard name="Prof.(Dr.) Avadhesh Kumar" role="Pro-VC" location="Galgotias University, India" image="/assets/persons/pvcsir.jpg" />
        </div>
        <div className="flex flex-col gap-10">
          <PersonCard name="Dr. Yogesh S. Chauhan" role="Professor" location="Indian Institute of Technology Kanpur Kanpur, U.P., India" image="/assets/persons/yogesh1.png" />
        </div>
      </Section>
    </div>
  );
...
const PersonCard: React.FC<{ name: string; role: string; image: string,location?:string }> = ({ name, role, image,location }) => {   
  return (
    <motion.div
